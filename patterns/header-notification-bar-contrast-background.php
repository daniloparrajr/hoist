 ...
 * Slug: hoist/header-notification-bar-contrast-background
 * Categories: header
...
<p class="has-text-align-center has-x-small-font-size" style="line-height:1.5"><?php echo esc_html__( 'With its minimal design and powerful feature set, Hoist enables agencies to build stylish websites.', 'hoist' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
...
<div class="wp-block-button has-custom-font-size" style="font-size:14px"><a class="wp-block-button__link wp-element-button" style="padding-top:5px;padding-right:15px;padding-bottom:5px;padding-left:15px"><?php echo esc_html__( 'Get Started', 'hoist' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
