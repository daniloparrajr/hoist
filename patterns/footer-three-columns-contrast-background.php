 ...
 * Slug: hoist/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'hoist' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'hoist' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'hoist' ); ?></a></p>
<!-- /wp:paragraph -->
