 ...
 * Slug: hoist/general-testimonials-image-contrast-background
...
<p style="margin-top:0"><?php echo esc_html__( 'With its clean, minimal design and powerful features, Hoist enables agencies to build cool websites.', 'hoist' ); ?></p>
<!-- /wp:paragraph -->
